...
$scope.ObjectToBack("Ellipse2");};
$App.NAB.Show1_hidden=true;
$App.NAB.show2_hidden=true;
$App.NAB.show3_hidden=true;
$App.NAB.show4_hidden=true;
$App.NAB.show5_hidden=true;
$App.NAB.Ellipse5_hidden=true;
$App.NAB.Ellipse6_hidden=true;
$App.NAB.Ellipse7_hidden=true;
...
$App.NAB.PageID = "Home";
$scope.PushButton9_click = function() {localStorage.setItem("question1",$App.question1);
...
$scope.PushButton10_click = function() {window.open("https://docs.google.com/spreadsheets/d/1xsijrJmqCkGSYY4xLQMs-NY8f_V3n5cq0cml9u8AI4E/edit?usp=sharing", "_blank");};
$scope.PushButton1_click = function() {$App.googleSheet = "https://docs.google.com/spreadsheets/d/1xsijrJmqCkGSYY4xLQMs-NY8f_V3n5cq0cml9u8AI4E/edit?usp=sharingadd #gid=X";
...
$scope.HideObject("show4","",0);
$scope.ObjectToBack("Ellipse2");};
$scope.Ellipse1_click = function() {$scope.ObjectToBack("Ellipse1");
...
$scope.PushButton5_click = function() {$App.sk4 = "0";
...
$App.q4d = "Sorry Incorect";};
$scope.PushButton6_click = function() {$App.sk4 = "1";
$scope.HideObject("b13","",0);
$scope.HideObject("b14","",0);
$scope.HideObject("b15","",0);
$scope.HideObject("b16","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk4,-1);
$App.q4d = "In-Correct";};
$scope.PushButton7_click = function() {$App.sk4 = "0";
$scope.HideObject("b13","",0);
$scope.HideObject("b14","",0);
$scope.HideObject("b15","",0);
$scope.HideObject("b16","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Sorry Incorect";};
$scope.PushButton11_click = function() {$App.sk4 = "0";
$scope.HideObject("b13","",0);
$scope.HideObject("b14","",0);
$scope.HideObject("b15","",0);
$scope.HideObject("b16","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk4,-1);
$App.q4d = "Correct";};
$scope.PushButton12_click = function() {$scope.GotoPage( "Page05" );};
});
...
$scope.HideObject("b17","",0);
$scope.HideObject("b18","",0);
$scope.HideObject("b19","",0);
$scope.HideObject("b20","",0);
...
$scope.HideObject("b20","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk5,-1);
$App.q5d = "Sorry in-correct";};
$scope.PushButton17_click = function() {$scope.GotoPage( "Page06" );};
});
...
$scope.PushButton18_click = function() {$App.sk6 = "0";
...
$App.q6d = "Sorry Incorect";};
$scope.PushButton19_click = function() {$App.sk6 = "0";
$scope.HideObject("b25","",0);
$scope.HideObject("b26","",0);
$scope.HideObject("b27","",0);
$scope.HideObject("b28","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk6,-1);
$App.q6d = "Correct";};
$scope.PushButton20_click = function() {$App.sk6 = "0";
$scope.HideObject("b25","",0);
$scope.HideObject("b26","",0);
$scope.HideObject("b27","",0);
$scope.HideObject("b28","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk6,-1);
$App.q6d = "Sorry Incorect";};
$scope.PushButton21_click = function() {$App.sk6 = "1";
$scope.HideObject("b25","",0);
$scope.HideObject("b26","",0);
$scope.HideObject("b27","",0);
$scope.HideObject("b28","",0);
...
$scope.PushButton23_click = function() {$App.sk3 = "0";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Sorry Incorect";};
$scope.PushButton24_click = function() {$App.sk3 = "1";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Correct";};
$scope.PushButton25_click = function() {$App.sk3 = "0";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Sorry Incorect";};
$scope.PushButton26_click = function() {$App.sk3 = "0";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
...
$scope.PushButton28_click = function() {$App.sk3 = "0";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Sorry Incorect";};
$scope.PushButton29_click = function() {$App.sk3 = "1";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Correct";};
$scope.PushButton30_click = function() {$App.sk3 = "0";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Sorry Incorect";};
$scope.PushButton31_click = function() {$App.sk3 = "0";
$scope.HideObject("b9","",0);
$scope.HideObject("b10","",0);
$scope.HideObject("b11","",0);
$scope.HideObject("b12","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q3d = "Sorry in-correct";};
$scope.PushButton32_click = function() {$scope.GotoPage( "Home" );};
});
