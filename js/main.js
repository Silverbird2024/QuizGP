...
$App.option1f = localStorage.getItem("option1f");
$App.option1g = localStorage.getItem("option1g");
...
$App.option2f = localStorage.getItem("option2f");
$App.option2g = localStorage.getItem("option2g");
...
$App.option5f = localStorage.getItem("option5f");
$App.option5g = localStorage.getItem("option5g");
...
$App.option6f = localStorage.getItem("option6f");
$App.option6g = localStorage.getItem("option6g");
...
$App.option7f = localStorage.getItem("option7f");
$App.option7g = localStorage.getItem("option7g");
...
$App.option8f = localStorage.getItem("option8f");
$App.option8g = localStorage.getItem("option8g");
...
$App.option9f = localStorage.getItem("option9f");
$App.option9g = localStorage.getItem("option9g");
...
$App.option10f = localStorage.getItem("option10f");
$App.option10g = localStorage.getItem("option10g");
...
$App.option11f = localStorage.getItem("option11f");
$App.option11g = localStorage.getItem("option11g");
...
$App.option12f = localStorage.getItem("option12f");
$App.option12g = localStorage.getItem("option12g");};
...
$App.NAB.PageID = "Home";
$scope.PushButton9_click = function() {$scope.HideObject("sd1","",0);
...
localStorage.setItem("option1f",$App.option1f);
localStorage.setItem("option1g",$App.option1g);
...
localStorage.setItem("option2f",$App.option2f);
localStorage.setItem("option2g",$App.option2g);
...
localStorage.setItem("option3f",$App.option3f);
localStorage.setItem("option3g",$App.option3g);
...
localStorage.setItem("option4f",$App.option4f);
localStorage.setItem("option4g",$App.option4g);
...
localStorage.setItem("option5f",$App.option5f);
localStorage.setItem("option5g",$App.option5g);
...
localStorage.setItem("option6f",$App.option6f);
localStorage.setItem("option6g",$App.option6g);
...
localStorage.setItem("option7f",$App.option7f);
localStorage.setItem("option7g",$App.option7g);
...
localStorage.setItem("option8f",$App.option8f);
localStorage.setItem("option8g",$App.option8g);
...
localStorage.setItem("option9f",$App.option9f);
localStorage.setItem("option9g",$App.option9g);
...
localStorage.setItem("option10f",$App.option10f);
localStorage.setItem("option10g",$App.option10g);
...
localStorage.setItem("option11f",$App.option11f);
localStorage.setItem("option11g",$App.option11g);
...
localStorage.setItem("option12f",$App.option12f);
localStorage.setItem("option12g",$App.option12g);
...
$scope.PushButton10_click = function() {window.open("https://docs.google.com/spreadsheets/d/1SUx689mPCnpOshbKechRq312Ce80i0vB2sr_2j3QS_0/edit?usp=sharing", "_blank");};
$scope.PushButton1_click = function() {$App.googleSheet = "https://docs.google.com/spreadsheets/d/1SUx689mPCnpOshbKechRq312Ce80i0vB2sr_2j3QS_0/edit?usp=sharingadd #gid=X";
...
neoGSheetsLoadCell($App.googleSheet,"option1e","f",1,null);

neoGSheetsLoadCell($App.googleSheet,"option1f","g",1,null);
...
neoGSheetsLoadCell($App.googleSheet,"option2e","f",2,null);

neoGSheetsLoadCell($App.googleSheet,"option2f","g",2,null);
...
neoGSheetsLoadCell($App.googleSheet,"option3e","f",3,null);
...
neoGSheetsLoadCell($App.googleSheet,"option7f","g",7,null);
...
neoGSheetsLoadCell($App.googleSheet,"option8f","g",8,null);
...
neoGSheetsLoadCell($App.googleSheet,"option9f","g",9,null);
...
neoGSheetsLoadCell($App.googleSheet,"option10f","g",10,null);
...
neoGSheetsLoadCell($App.googleSheet,"option11f","g",11,null);
...
neoGSheetsLoadCell($App.googleSheet,"option12f","g",12,null);

$App.loaded = "loaded";
$scope.GotoPage( "Page01" );
$scope.GotoPage( "Home" );};
$scope.PushButton4_click = function() {window.document.location.reload();
$scope.GotoPage( "Home" );};
});
...
neoGSheetsLoadCell($App.googleSheet,"q1d","f",1,null);

$App.qt = $scope.Calculate($App.qt+"+"+$App.sk1,-1);
$App.q1d = $App.option1e;
...
$App.q1d = $App.option1f;
$scope.ShowObject("sd1","fadeIn",24);};
$scope.PushButton2_click = function() {$scope.GotoPage( "Page02" );};
});
...
$App.q2d = $App.option2f;
$scope.ShowObject("sd2","fadeIn",24);};
$scope.PushButton3_click = function() {$scope.GotoPage( "Page03" );};
});
...
$App.q3d = $App.option3f;
$scope.ShowObject("sd3","fadeIn",24);};
$scope.PushButton5_click = function() {$scope.GotoPage( "Page04" );};
});
...
$scope.HideObject("b16","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk4,-1);
$App.q4d = $App.option4e;
$scope.ShowObject("sd4","fadeIn",24);};
$scope.PushButton6_click = function() {$scope.GotoPage( "Page05" );};
});
...
$App.q5d = $App.option5f;
$scope.ShowObject("sd5","fadeIn",24);};
$scope.PushButton7_click = function() {$scope.GotoPage( "Page06" );};
});
...
$scope.HideObject("b28","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk6,-1);
$App.q6d = $App.option6e;
$scope.ShowObject("sd6","fadeIn",24);};
$scope.PushButton8_click = function() {$scope.GotoPage( "Page07" );};
});
...
$scope.HideObject("b32","",0);
$App.qt = $scope.Calculate($App.qt+"+"+$App.sk3,-1);
$App.q7d = $App.option7g;
$scope.ShowObject("sd7","fadeIn",24);};
$scope.PushButton11_click = function() {$scope.GotoPage( "Page08" );};
});
...
$App.q8d = $App.option8f;
$scope.ShowObject("sd8","fadeIn",24);};
$scope.PushButton12_click = function() {$scope.GotoPage( "Page09" );};
});
...
$App.q9d = $App.option9f;
$scope.ShowObject("sd9","fadeIn",24);};
$scope.PushButton13_click = function() {$scope.GotoPage( "Page10" );};
});
...
$App.q10d = $App.option10f;
$scope.ShowObject("sd10","fadeIn",24);};
$scope.PushButton14_click = function() {$scope.GotoPage( "Page11" );};
});
...
$App.q11d = $App.option11f;
$scope.ShowObject("sd11","fadeIn",24);};
$scope.PushButton15_click = function() {$scope.GotoPage( "Page12" );};
});
...
$scope.PushButton40_click = function() {$App.sk12 = "0";
